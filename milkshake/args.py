...
def add_input_args(parser):
    ...
    parser.add("--num_classes", default=2, type=int,
               help="The number of classes to use for model output.")
    ...
    parser.add("--resnet_pretrained", choices=["imagenet1k", "none"], default="imagenet1k",
               help="The pretrained weights to use in the ResNet.")
